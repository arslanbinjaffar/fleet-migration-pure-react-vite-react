...
import { useCreateCustomerMutation } from '../../../stores/api/customerApiSlice';
...
const CustomerCreate: React.FC = () => {
  ...
  const [createCustomer, { isLoading: isSubmitting }] = useCreateCustomerMutation();
  ...
  const { control, handleSubmit, watch, trigger, formState: { errors, isValid } } = form;
